...
public class MeteoriteSpawner {
    public PlacedMeteoriteSettings trySpawnMeteorite(World world, BlockPos startPos,
        ...
        return new PlacedMeteoriteSettings(startPos, coreRadius, craterType, pureCrater, craterLake, fallout);
    }
}
