...
public class NewCompassRegion extends WorldSavedData {
    /**
    ...
    public NewCompassRegion(String name) {
        super(name);
    }
     ...
     */
    public static NewCompassRegion get(WorldServer world, ChunkPos chunkPos) {
        ...
        var compassRegion = (NewCompassRegion) worldStorage.getOrLoadData(NewCompassRegion.class, name);
        if (compassRegion == null) {
            compassRegion = new NewCompassRegion(name);
